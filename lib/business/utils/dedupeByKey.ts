...
// (Dependency, OperationalRisk). A local copy, not imported from any
// upstream platform's equivalent — none of them re-export this from
// their public barrels, and this milestone's rule is "consume only
// public exports."

...
// Milestone 125 (previously in-memory) — the decision stage reaches them
// transitively through synthesizeDecision's own resolveMarketKnowledge/
// resolveCompetitorKnowledge calls regardless of which
// PipelineExecutionStore this file passes in explicitly (a separate
// concern). Mocked at the factory level with a real MemoryMarketStore/
// MemoryCompetitorStore underneath, mirroring
// lib/services/analysisSessions.test.ts's own identical precedent for
// lib/pipeline/storage/createStore.

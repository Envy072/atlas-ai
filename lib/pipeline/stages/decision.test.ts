...
// Milestone 125 (previously in-memory) — decisionStage reaches them
// transitively through synthesizeDecision's own resolveMarketKnowledge/
// resolveCompetitorKnowledge calls, neither of which is given its own
// store. Mocked at the factory level with a real MemoryMarketStore/
